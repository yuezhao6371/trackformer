...
def main(config_path):
    ...
    logging.info(f'Total wallclock time (including scoring): {total_wallclock_time_ms:.2f} ms')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Measuring the inference speed of a model with a given config file.")
